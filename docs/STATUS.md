...
|---|---|---|---|---|
| 0D | drv-0D | Survey implemented + green (E3 PASS; synthetic 10/15, CDP 14/15, 4 CDP-rescues); awaiting owner E1 live run + E2 §8 default = CDP | `docs/plans/0D-click-dispatch-survey.md` | 2026-09-05 |
